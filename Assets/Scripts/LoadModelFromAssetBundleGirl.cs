...
public class LoadModelFromAssetBundleGirl : MonoBehaviour
{
    ...
    IEnumerator LoadAssetBundle()
    {
        ...
        string path = System.IO.Path.Combine(Application.streamingAssetsPath, "prefabgirl");
        ...
        // 加载第一个目标对象的模型
        AssetBundleRequest request1 = loadedBundle.LoadAssetAsync<GameObject>("FemaleCharacterPBR");
        ...
        // 加载第二个目标对象的材质
        AssetBundleRequest request2 = loadedBundle.LoadAssetAsync<Material>("yellow");
